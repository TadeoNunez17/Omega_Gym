-- On link: copies registered user's full_name, email, phone to admin profile
-- On unlink: restores admin's original name from alias, clears email/phone
...
BEGIN
  ...
  -- Restore admin profile to pending state
  ...
  -- Restore registered user profile
