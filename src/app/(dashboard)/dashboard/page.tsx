        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 mb-5">
          ...
          <div className="bg-surface border border-border rounded-lg overflow-hidden">
            <div className="flex items-center justify-between px-4 sm:px-5 py-4 border-b border-border">
              ...
              <Link href="/reports" className="text-[11px] text-text-3 no-underline cursor-pointer">Ver reporte →</Link>
            </div>
          ...
          <div className="bg-surface border border-border rounded-lg overflow-hidden">
            ...
            <div className="px-4 sm:px-5 py-3 border-t border-border">
              <Link href="/payments" className="text-[11px] text-text-3 no-underline cursor-pointer">Ver todos los pagos →</Link>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
          ...
          <div className="bg-surface border border-border rounded-lg overflow-hidden">
            <div className="flex items-center justify-between px-4 sm:px-5 py-4 border-b border-border">
              ...
              <Link href="/memberships" className="text-[11px] text-text-3 no-underline cursor-pointer">Ver membresías →</Link>
            </div>
            <div className="flex flex-col">
              {[
