  ...
  return (
    <div className="bg-surface border border-border rounded p-8">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 py-[10px] rounded-sm border border-border bg-bg text-text text-[13px] font-medium cursor-pointer hover:bg-surface2 transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed font-sans"
      >
        {googleLoading ? (
